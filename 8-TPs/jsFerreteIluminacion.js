...
o “FelipeLamparas” se hace un descuento del 25 % y
...
function CalcularPrecio () 
{
    ...
    if (descuento >= 120) {
        ingresos = ( descuento * 10 / 100)
        precioDescuento = descuento + ingresos  }

    }

    document.getElementById("precioDescuento")= " IIBB. Usted pago " + precioDescuento + ", siendo " + ingresos + " el impuesto que se pagó.";
